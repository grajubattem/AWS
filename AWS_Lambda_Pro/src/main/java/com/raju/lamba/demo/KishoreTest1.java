...
public class KishoreTest1 implements RequestHandler<Object, String> {
	...
	public final static String ACCESS_KEY = "aws_access_key_id";
	public final static String SECRET_KEY = "aws_secret_access_key";
